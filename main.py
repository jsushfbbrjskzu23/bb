...
\x1b[1;92m
\x1b[1;96m
\x1b[1;92m          _____   ____     ___    ____    _____ 
\x1b[1;92m         |  ___| |  _ \   / _ \  / ___|  |_   _|
\x1b[1;92m         | |_    | |_) | | | | | \___ \    | |  
\x1b[1;92m         |  _|   |  _ <  | |_| |  ___) |   | |  
\x1b[1;92m         |_|     |_| \_\  \___/  |____/    |_|  
\x1b[1;93m
\x1b[1;95m            × Facebook Auto Create Account ×
\x1b[1;91m____________________________________________________________
\x1b[1;91m
\x1b[1;97m ✓ Author : Frost Dev
\x1b[1;97m ✓ Facebok: Frost Dev
\x1b[1;97m ✓ Version: 1.0.1
\x1b[0;97m____________________________________________________________"""
...
def menu():
    ...
    print (logo4)
    print ('')
    print ('• 1 • Facebook Auto Create Acc')
    print ('• 2 • Facebook Author')
    print (60*'_')
    sel = input('Select: ')
    if sel in['1', '01']:
        create().start()
    elif sel in ['2', '02']:
        os.system('xdg-open https://www.facebook.com/profile.php?id=61558861324061')
        menu()
    elif sel in ['3', '03']:
...
class create:
    ...
    def start(self):
        ...
        for x in range(lim):
            self.loop += 1
            sys.stdout.write(f'\r {OO}[Process] {OO}{self.loop}/{str(lim)} ✓:{len(ok)} - ✘ :{len(cp)}{OO} '),
            sys.stdout.flush()
            ...
            try:
                ...
                if 'checkpoint' in getts.url:
                    ...
                    print ('\r\033[1;33m[ ✘ ] '+cok['c_user']+' | '+passw+'\033[0;97m     ')
        ...
        print (47*'-')
        print ('\033[1;32mTotal ids > ✓ /' +str(len(ok)) + ' ✘ /' + str(len(cp)))
        print (47*'-')
        input('back')
        menu()
menu()
